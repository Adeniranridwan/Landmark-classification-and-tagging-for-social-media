...
def get_data_loaders(
    ...
    data_transform = {
        "train": transforms.Compose([
                                     ...
                                     transforms.RandomAffine(scale = (1.0, 1.25), translate = (0, 0.1), degrees =(-15,15), shear = (-10, 10)), 
    ...
    train_data = datasets.ImageFolder(
        base_path / "train", transform= data_transform['train']
    ...
    valid_data = datasets.ImageFolder(
        base_path / "train",transform = data_transform ['valid']
        # YOUR CODE HERE: add the appropriate transform that you defined in
        # the data_transforms dictionary
    )
    ...
    test_data = datasets.ImageFolder(
        base_path / "test",transform = data_transform['test']
